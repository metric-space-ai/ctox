...
def main() -> int:
    parser = argparse.ArgumentParser(description="Query incident_response state from the shared SQLite kernel.")
    ...
    if args.command == "summary":
        print(json.dumps(shared.summary(conn, "incident_response"), indent=2))
        return 0
    print(json.dumps(shared.export_cytoscape(conn, "incident_response"), indent=2))
    return 0
