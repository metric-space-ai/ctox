...
def main() -> int:
    parser = argparse.ArgumentParser(description="Query automation_engineering state from the shared SQLite kernel.")
    ...
    if args.command == "summary":
        print(json.dumps(shared.summary(conn, "automation_engineering"), indent=2))
        return 0
    print(json.dumps(shared.export_cytoscape(conn, "automation_engineering"), indent=2))
    return 0
