...
def main() -> int:
    parser = argparse.ArgumentParser(description="Query ops_insight state from the shared SQLite kernel.")
    ...
    if args.command == "summary":
        print(json.dumps(shared.summary(conn, "ops_insight"), indent=2))
        return 0
    print(json.dumps(shared.export_cytoscape(conn, "ops_insight"), indent=2))
    return 0
