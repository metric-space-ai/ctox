...
COLLECTOR_SCRIPT = SCRIPT_DIR / "reliability_collect.py"
STORE_SCRIPT = SCRIPT_DIR / "reliability_store.py"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run reliability collectors and persist raw captures into shared SQLite.")
        ...
        json.dumps(
            {
                ...
                "run_id": stored.get("run_id") or raw.get("run_id"),
