...
def main() -> int:
    parser = argparse.ArgumentParser(description="Query reliability_ops state from the shared SQLite kernel.")
    ...
    if args.command == "summary":
        print(json.dumps(shared.summary(conn, "reliability_ops"), indent=2))
        return 0
    print(json.dumps(shared.export_cytoscape(conn, "reliability_ops"), indent=2))
    return 0
