...
pub trait VisionModel: IsqModel + AnyMoeBaseModelMixin {
    ...
    fn model_config_like(&self) -> Arc<dyn ModelConfigLike + Send + Sync> {
...
impl FromStr for VisionLoaderType {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            a => Err(format!("Unknown architecture `{a}`. Possible architectures: `phi3v`, `idefics2`, `llava_next`, `llava`, `vllama`, `qwen2vl`, `idefics3`, `minicpmo`, `phi4mm`, `qwen2_5vl`, `gemma3`, `engine3`, `llama4`, `gemma3n`, `gemma4`, `qwen3vl`, `qwen3vlmoe`, `qwen3_5`, `qwen3_5moe`, `voxtral`.")),
        }
    }
}
...
impl std::fmt::Display for VisionLoaderType {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let name = match self {
            ...
            VisionLoaderType::Mistral3 => "engine3",
...
///
/// [`VisionLoader`]: https://docs.rs/engine/latest/engine/struct.VisionLoader.html
...
impl DeviceMappedModelLoader for Mistral3Loader {
    fn mapped_max_act_size_elems(
        ...
        let img_seq_len = {
            ...
            // https://huggingface.co/engineai/Mistral-Small-3.1-24B-Instruct-2503/blob/main/preprocessor_config.json#L29
...
impl DeviceMappedModelLoader for Gemma4Loader {
    fn mapped_max_act_size_elems(
        ...
        let AutoDeviceMapParams::Vision {
            ...
            anyhow::bail!("Expected vision AutoDeviceMapParams for Gemma4");
        };
        ...
        let total_seq_len = *max_seq_len.min(&ATTENTION_CHUNK_SIZE)
            + vision_tokens_per_image * max_num_images
            + audio_tokens;
    ...
    fn non_mapped_sub_models(&self) -> Option<Vec<NonMappedSubModel>> {
        let mut models = vec![NonMappedSubModel::Vision];
    ...
    fn model_config(&self, config: &str) -> Result<Box<dyn ModelConfigLike>> {
        ...
        let cfg = ModelConfigMetadata {
            ...
            sliding_window: Some(tc.effective_sliding_window()),
