...
export const skr03Chart: ChartOfAccounts = {
  ...
  accounts: [
    ...
    { id: "acc-fixed-assets", code: "0480", name: "Betriebs- und Geschaeftsausstattung", rootType: "asset", accountType: "fixed_asset", currency: "EUR" },
    { id: "acc-accumulated-depreciation", code: "0490", name: "Kumulierte Abschreibungen auf Sachanlagen", rootType: "asset", accountType: "accumulated_depreciation", currency: "EUR" },
    { id: "acc-vat-input", code: "1576", name: "Abziehbare Vorsteuer 19%", rootType: "asset", accountType: "tax", currency: "EUR" },
    { id: "acc-vat-input-7", code: "1571", name: "Abziehbare Vorsteuer 7%", rootType: "asset", accountType: "tax", currency: "EUR" },
    ...
    { id: "acc-vat-output-7", code: "1771", name: "Umsatzsteuer 7%", rootType: "liability", accountType: "tax", currency: "EUR" },
    ...
    { id: "acc-depreciation", code: "4830", name: "Abschreibungen auf Sachanlagen", rootType: "expense", accountType: "depreciation", currency: "EUR" },
