...
Only the encrypted encrypted CTOX secret store and related runtime records count as durable secret knowledge. Workspace notes or copied values do not count as durable knowledge by themselves.
...
This stores the secret in the encrypted CTOX secret store and rewrites the specified conversation memory to `[secret-ref:<scope>/<name>]`.
