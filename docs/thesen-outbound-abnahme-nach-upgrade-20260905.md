...
## 08.09., 14:41–15:36 UTC: Beweislauf aus dem Claude-Browser (sichtbar) unter Release 20260908T100752Z

| Schritt | Messung |
|---|---|
| Browser | Nach Einblenden der Browser-Ansicht (`document.hidden=false`) und Schließen des Owner-Tabs: 17–23 Kollektionen live, 9–13 Neustarts statt > 2.000; Befehls-Push kommt an. Hintergrund-Tab und paralleler Owner-Tab desselben Nutzers waren die Blocker (Befund an Crew-Thread 01a08175…). |
| Start | 14:51 „Neue Recherche" von der App abgelehnt (Calvatis in Sellify, contact_id 17616 — um 14:31 hatte dieselbe Prüfung „nicht in Sellify" gemeldet: Lookup-Timeout wird als „nicht gefunden" gewertet). 14:53:29 „Auswahl nachrecherchieren (1)" → `business_os.chat.task` 14:56:23 angenommen, Task `1a3b5a89` geleast 14:54:48, Worker 14:54:50 „Starte eine Outbound Nachrecherche für Calvatis GmbH". |
| Versuch 1 | 14:54:50–15:24:51: Stream-Disconnect des LLM-Anbieters nach 30 min → Technik-Hold (`failure_class=technical`, attempt 2), kein terminaler Fehler (Retry-Gate aus Upgrade 14 wirkt). |
| Versuch 2 | 15:29:56–15:34:40: Worker `ok`. Writeback 15:34:05 angenommen: 32 Felder geliefert, 21 verified, 11 no_match, 37 Belege verworfen, „0 Felder noch offen". |
| Ergebnis Lead | Calvatis 9 → 14 recherchierte/verifizierte Felder (firma_name, aktivitaetsstatus, anschrift, plz, ort, land, domain, geschaeftstaetigkeit, homepage_fact_sheet, fruehere_namen, geschaeftsfuehrung, prokura, telefon, fax). Befehl 15:35:40 `awaiting_review` mit Nutzerantwort „Nachrecherche … abgeschlossen und an Sellify zurückgespielt". |
| Verlust | 7 verifizierte Personenfelder (person_vorname/nachname/funktion/position/email/email_validation …) verworfen: „result.fields.person_*: person_key fehlt" — Worker liefert Personenwerte ohne `person_key`/`person_records`, obwohl 2 Kontakte am Lead hängen. Kandidat für die nächste Toleranzrunde (Personenwerte bei genau einem Zielkontakt zuordnen) oder Skill-Härtung. |
| Bewertung | Recherche läuft unter dem neuen Release korrekt durch: Start aus der App, Lease, Worker, Wiederholung nach Anbieterabbruch, Writeback-Kontrakt, Merge (+5 Felder, nichts verloren), Review-Phase. Offen: Personenfeld-Form, Anbieter-Disconnects. |
