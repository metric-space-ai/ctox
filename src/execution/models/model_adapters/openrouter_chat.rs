...
pub fn rewrite_request(
    ...
    serde_json::to_vec(&Value::Object(request))
        .with_context(|| format!("failed to encode {adapter_label} chat-completions payload"))
}
...
pub fn rewrite_success_response(
    ...
    serde_json::to_vec(&response_payload)
        .with_context(|| format!("failed to encode {adapter_label} responses payload"))
}
