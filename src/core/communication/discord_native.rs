...
pub(crate) fn sync(
    ...
    chat_native::sync(ChatPlatform::Discord, root, runtime, request)
}
...
pub(crate) fn send(
    ...
    chat_native::send(ChatPlatform::Discord, root, runtime, request)
}
...
pub(crate) fn test(
    ...
    chat_native::test(ChatPlatform::Discord, root, runtime, request)
}
...
pub(crate) fn service_sync(
    ...
    chat_native::service_sync(ChatPlatform::Discord, root, settings)
}
