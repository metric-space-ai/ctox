...
pub(crate) fn sync(
    ...
    chat_native::sync(ChatPlatform::Telegram, root, runtime, request)
}
...
pub(crate) fn send(
    ...
    chat_native::send(ChatPlatform::Telegram, root, runtime, request)
}
...
pub(crate) fn test(
    ...
    chat_native::test(ChatPlatform::Telegram, root, runtime, request)
}
...
pub(crate) fn service_sync(
    ...
    chat_native::service_sync(ChatPlatform::Telegram, root, settings)
}
