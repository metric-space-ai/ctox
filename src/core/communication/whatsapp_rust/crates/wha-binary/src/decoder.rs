...
impl<'a> Decoder<'a> {
    ...
    fn read_int8(&mut self) -> Result<usize, BinaryError> {
        self.read_int_n(1, false)
    }
    fn read_int16(&mut self) -> Result<usize, BinaryError> {
        self.read_int_n(2, false)
    }
    fn read_int32(&mut self) -> Result<usize, BinaryError> {
