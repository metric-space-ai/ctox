...
const ALICE_IDENTITY_PUB: &str = "a4e09292b651c278b9772c569f5fa9bb13d906b46ab68c9df9dc2b4409f8a209";
...
const ALICE_PRE_KEY_PRIV: &str = "0003030303030303030303030303030303030303030303030303030303030343";
const ALICE_PRE_KEY_PUB: &str = "5dfedd3b6bd47f6fa28ee15d969d5bb0ea53774d488bdaf9df1c6e0124b3ef22";
const ALICE_REGISTRATION_ID: u32 = 12345;

// --- Bob (sender) ---
const BOB_IDENTITY_PUB: &str = "ac01b2209e86354fb853237b5de0f4fab13c7fcbf433a61c019369617fecf10b";
const BOB_BASE_PUB: &str = "50a61409b1ddd0325e9b16b700e719e9772c07000b1bd7786e907c653d20495d";

// --- X3DH outputs (for cross-checking) ---
const X3DH_ROOT_KEY: &str = "93042a88ec05fa80852fe697fa600deab70187b247c7b84baf8f904afa10b2b9";
...
const CIPHERTEXT1: &str = "e48a77815cc5e852cee3380cd6a1df093f1427aadcf88eb158f8ad1ddd00a054";
...
fn pre_key_signal_message_decode_yields_expected_fields() {
    ...
    assert!(
        !bytes.is_empty(),
        "PRE_KEY_SIGNAL_MESSAGE_HEX must be populated"
    );
...
fn signal_message_decode_yields_expected_fields() {
    ...
    let parsed =
        SignalMessage::deserialize(&bytes).expect("decoder must accept libsignal's SignalMessage");
...
fn decrypt_pre_key_signal_message_recovers_plaintext() {
    ...
    let plaintext2 =
        wha_signal::SessionCipher::decrypt(&mut alice_state, &hex_decode(SIGNAL_MESSAGE_HEX))
