...
const SIGNING_KEY_PRIV: &str = "0007070707070707070707070707070707070707070707070707070707070747";
const SIGNING_KEY_PUB: &str = "13be4feaeaf204c7fd3358fc9c00721881d174278128227ec674f37f7fe97b6d";
...
fn name() -> SenderKeyName {
    SenderKeyName::new(
        "test-group@g.us".to_string(),
        SignalAddress::new("alice", 1),
    )
}
...
fn decrypt_second_message_after_first() {
    ...
    let plaintext =
        SenderKeyMessage::decrypt(&mut rec, &name(), &hex_decode(SENDER_KEY_MESSAGE_2_HEX))
