...
impl SignalMessage {
    ...
    pub fn new(
        ...
        let body =
            encode_signal_message_body(&sender_ratchet_key, counter, previous_counter, &ciphertext);
        ...
        let mac_full = hmac_sha256_concat(
            mac_key,
            &[&sender_id33, &receiver_id33, &[version_byte][..], &body],
        );
...
fn decode_prekey_signal_message_body(
    ...
    Ok(PreKeySignalMessage {
        ...
        identity_key: identity_key
            .ok_or(SignalProtocolError::InvalidMessage("missing identityKey"))?,
...
mod tests {
    ...
    fn round_trip_signal_message() {
        ...
        parsed
            .verify_mac(&mac_key, &sender_id, &receiver_id)
            .unwrap();
    }
