...
pub(crate) fn sync(
    ...
    chat_native::sync(ChatPlatform::Zulip, root, runtime, request)
}
...
pub(crate) fn send(
    ...
    chat_native::send(ChatPlatform::Zulip, root, runtime, request)
}
...
pub(crate) fn test(
    ...
    chat_native::test(ChatPlatform::Zulip, root, runtime, request)
}
...
pub(crate) fn service_sync(
    ...
    chat_native::service_sync(ChatPlatform::Zulip, root, settings)
}
