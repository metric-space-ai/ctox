...
pub(crate) fn sync(
    ...
    chat_native::sync(ChatPlatform::Matrix, root, runtime, request)
}
...
pub(crate) fn send(
    ...
    chat_native::send(ChatPlatform::Matrix, root, runtime, request)
}
...
pub(crate) fn test(
    ...
    chat_native::test(ChatPlatform::Matrix, root, runtime, request)
}
...
pub(crate) fn service_sync(
    ...
    chat_native::service_sync(ChatPlatform::Matrix, root, settings)
}
