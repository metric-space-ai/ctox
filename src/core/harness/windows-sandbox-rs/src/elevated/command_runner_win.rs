...
use anyhow::Context;
use anyhow::Result;
use ctox_windows_sandbox::allow_null_device;
use ctox_windows_sandbox::convert_string_sid_to_sid;
use ctox_windows_sandbox::create_readonly_token_with_caps_from;
use ctox_windows_sandbox::create_workspace_write_token_with_caps_from;
use ctox_windows_sandbox::get_current_token_for_restriction;
use ctox_windows_sandbox::hide_current_user_profile_dir;
use ctox_windows_sandbox::ipc_framed::decode_bytes;
use ctox_windows_sandbox::ipc_framed::encode_bytes;
use ctox_windows_sandbox::ipc_framed::read_frame;
use ctox_windows_sandbox::ipc_framed::write_frame;
use ctox_windows_sandbox::ipc_framed::ErrorPayload;
use ctox_windows_sandbox::ipc_framed::ExitPayload;
use ctox_windows_sandbox::ipc_framed::FramedMessage;
use ctox_windows_sandbox::ipc_framed::Message;
use ctox_windows_sandbox::ipc_framed::OutputPayload;
use ctox_windows_sandbox::ipc_framed::OutputStream;
use ctox_windows_sandbox::log_note;
use ctox_windows_sandbox::parse_policy;
use ctox_windows_sandbox::read_handle_loop;
use ctox_windows_sandbox::spawn_process_with_pipes;
use ctox_windows_sandbox::to_wide;
use ctox_windows_sandbox::PipeSpawnHandles;
use ctox_windows_sandbox::SandboxPolicy;
use ctox_windows_sandbox::StderrMode;
use ctox_windows_sandbox::StdinMode;
use std::ffi::c_void;
use std::fs::File;
...
fn read_spawn_request(reader: &mut File) -> Result<ctox_windows_sandbox::ipc_framed::SpawnRequest> {
...
fn spawn_ipc_process(
    req: &ctox_windows_sandbox::ipc_framed::SpawnRequest,
    ...
    let (pi, stdout_handle, stderr_handle, stdin_handle) = if req.tty {
        let (pi, conpty) = ctox_windows_sandbox::spawn_conpty_process_as_user(
            h_token,
            &req.command,
            &effective_cwd,
            &req.env,
...
pub fn main() -> Result<()> {
    ...
    let msg = FramedMessage {
        ...
        message: Message::SpawnReady {
            payload: ctox_windows_sandbox::ipc_framed::SpawnReady {
