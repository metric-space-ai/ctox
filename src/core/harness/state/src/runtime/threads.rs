...
mod tests {
    ...
    use ctox_protocol::protocol::GitInfo;
    ...
    async fn apply_rollout_items_uses_override_updated_at_when_provided() {
        ...
        let items = vec![RolloutItem::EventMsg(EventMsg::TokenCount(
            ctox_protocol::protocol::TokenCountEvent {
                info: Some(ctox_protocol::protocol::TokenUsageInfo {
                    total_token_usage: ctox_protocol::protocol::TokenUsage {
                        input_tokens: 0,
                    ...
                    last_token_usage: ctox_protocol::protocol::TokenUsage::default(),
