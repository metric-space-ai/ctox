...
```rust
use ctox_utils_stream_parser::CitationStreamParser;
use ctox_utils_stream_parser::StreamTextParser;
...
```rust
use ctox_utils_stream_parser::CitationStreamParser;
use ctox_utils_stream_parser::Utf8StreamParser;

# fn demo() -> Result<(), ctox_utils_stream_parser::Utf8StreamParserError> {
...
```rust
use ctox_utils_stream_parser::InlineHiddenTagParser;
use ctox_utils_stream_parser::InlineTagSpec;
use ctox_utils_stream_parser::StreamTextParser;
