...
use chrono::Utc;
use ctox_app_server_protocol::Account;
use ctox_app_server_protocol::AccountLoginCompletedNotification;
use ctox_app_server_protocol::AccountUpdatedNotification;
use ctox_app_server_protocol::AppsListParams;
use ctox_app_server_protocol::AskForApproval;
use ctox_app_server_protocol::AuthMode;
use ctox_app_server_protocol::CancelLoginAccountParams;
use ctox_app_server_protocol::CancelLoginAccountResponse;
use ctox_app_server_protocol::CancelLoginAccountStatus;
use ctox_app_server_protocol::ClientRequest;
use ctox_app_server_protocol::CollaborationModeListParams;
use ctox_app_server_protocol::CollaborationModeListResponse;
use ctox_app_server_protocol::CommandExecParams;
use ctox_app_server_protocol::CommandExecResizeParams;
use ctox_app_server_protocol::CommandExecTerminateParams;
use ctox_app_server_protocol::CommandExecWriteParams;
use ctox_app_server_protocol::ConversationGitInfo;
use ctox_app_server_protocol::ConversationSummary;
use ctox_app_server_protocol::DynamicToolSpec as ApiDynamicToolSpec;
use ctox_app_server_protocol::ExperimentalFeature as ApiExperimentalFeature;
use ctox_app_server_protocol::ExperimentalFeatureListParams;
use ctox_app_server_protocol::ExperimentalFeatureListResponse;
use ctox_app_server_protocol::ExperimentalFeatureStage as ApiExperimentalFeatureStage;
use ctox_app_server_protocol::FeedbackUploadParams;
use ctox_app_server_protocol::FeedbackUploadResponse;
use ctox_app_server_protocol::FuzzyFileSearchParams;
use ctox_app_server_protocol::FuzzyFileSearchResponse;
use ctox_app_server_protocol::FuzzyFileSearchSessionStartParams;
use ctox_app_server_protocol::FuzzyFileSearchSessionStartResponse;
use ctox_app_server_protocol::FuzzyFileSearchSessionStopParams;
use ctox_app_server_protocol::FuzzyFileSearchSessionStopResponse;
use ctox_app_server_protocol::FuzzyFileSearchSessionUpdateParams;
use ctox_app_server_protocol::FuzzyFileSearchSessionUpdateResponse;
use ctox_app_server_protocol::GetAccountParams;
use ctox_app_server_protocol::GetAccountRateLimitsResponse;
use ctox_app_server_protocol::GetAccountResponse;
use ctox_app_server_protocol::GetAuthStatusParams;
use ctox_app_server_protocol::GetAuthStatusResponse;
use ctox_app_server_protocol::GetConversationSummaryParams;
use ctox_app_server_protocol::GetConversationSummaryResponse;
use ctox_app_server_protocol::GitDiffToRemoteResponse;
use ctox_app_server_protocol::GitInfo as ApiGitInfo;
use ctox_app_server_protocol::JSONRPCErrorError;
use ctox_app_server_protocol::ListMcpServerStatusParams;
use ctox_app_server_protocol::ListMcpServerStatusResponse;
use ctox_app_server_protocol::LoginAccountParams;
use ctox_app_server_protocol::LoginAccountResponse;
use ctox_app_server_protocol::LoginApiKeyParams;
use ctox_app_server_protocol::LogoutAccountResponse;
use ctox_app_server_protocol::MarketplaceInterface;
use ctox_app_server_protocol::McpServerOauthLoginCompletedNotification;
use ctox_app_server_protocol::McpServerOauthLoginParams;
use ctox_app_server_protocol::McpServerOauthLoginResponse;
use ctox_app_server_protocol::McpServerRefreshResponse;
use ctox_app_server_protocol::McpServerStatus;
use ctox_app_server_protocol::MockExperimentalMethodParams;
use ctox_app_server_protocol::MockExperimentalMethodResponse;
use ctox_app_server_protocol::ModelListParams;
use ctox_app_server_protocol::ModelListResponse;
use ctox_app_server_protocol::PluginDetail;
use ctox_app_server_protocol::PluginInstallParams;
use ctox_app_server_protocol::PluginInstallResponse;
use ctox_app_server_protocol::PluginInterface;
use ctox_app_server_protocol::PluginListParams;
use ctox_app_server_protocol::PluginListResponse;
use ctox_app_server_protocol::PluginMarketplaceEntry;
use ctox_app_server_protocol::PluginReadParams;
use ctox_app_server_protocol::PluginReadResponse;
use ctox_app_server_protocol::PluginSource;
use ctox_app_server_protocol::PluginSummary;
use ctox_app_server_protocol::PluginUninstallParams;
use ctox_app_server_protocol::PluginUninstallResponse;
use ctox_app_server_protocol::RequestId;
use ctox_app_server_protocol::ReviewDelivery as ApiReviewDelivery;
use ctox_app_server_protocol::ReviewStartParams;
use ctox_app_server_protocol::ReviewStartResponse;
use ctox_app_server_protocol::ReviewTarget as ApiReviewTarget;
use ctox_app_server_protocol::SandboxMode;
use ctox_app_server_protocol::ServerNotification;
use ctox_app_server_protocol::ServerRequestResolvedNotification;
use ctox_app_server_protocol::SkillSummary;
use ctox_app_server_protocol::SkillsConfigWriteParams;
use ctox_app_server_protocol::SkillsConfigWriteResponse;
use ctox_app_server_protocol::SkillsListParams;
use ctox_app_server_protocol::SkillsListResponse;
use ctox_app_server_protocol::Thread;
use ctox_app_server_protocol::ThreadArchiveParams;
use ctox_app_server_protocol::ThreadArchiveResponse;
use ctox_app_server_protocol::ThreadArchivedNotification;
use ctox_app_server_protocol::ThreadBackgroundTerminalsCleanParams;
use ctox_app_server_protocol::ThreadBackgroundTerminalsCleanResponse;
use ctox_app_server_protocol::ThreadClosedNotification;
use ctox_app_server_protocol::ThreadCompactStartParams;
use ctox_app_server_protocol::ThreadCompactStartResponse;
use ctox_app_server_protocol::ThreadDecrementElicitationParams;
use ctox_app_server_protocol::ThreadDecrementElicitationResponse;
use ctox_app_server_protocol::ThreadForkParams;
use ctox_app_server_protocol::ThreadForkResponse;
use ctox_app_server_protocol::ThreadIncrementElicitationParams;
use ctox_app_server_protocol::ThreadIncrementElicitationResponse;
...
use ctox_app_server_protocol::ThreadLoadedListParams;
use ctox_app_server_protocol::ThreadLoadedListResponse;
use ctox_app_server_protocol::ThreadMetadataGitInfoUpdateParams;
use ctox_app_server_protocol::ThreadMetadataUpdateParams;
use ctox_app_server_protocol::ThreadMetadataUpdateResponse;
use ctox_app_server_protocol::ThreadNameUpdatedNotification;
use ctox_app_server_protocol::ThreadReadParams;
use ctox_app_server_protocol::ThreadReadResponse;
use ctox_app_server_protocol::ThreadRealtimeAppendAudioParams;
use ctox_app_server_protocol::ThreadRealtimeAppendAudioResponse;
use ctox_app_server_protocol::ThreadRealtimeAppendTextParams;
use ctox_app_server_protocol::ThreadRealtimeAppendTextResponse;
use ctox_app_server_protocol::ThreadRealtimeStartParams;
use ctox_app_server_protocol::ThreadRealtimeStartResponse;
use ctox_app_server_protocol::ThreadRealtimeStopParams;
use ctox_app_server_protocol::ThreadRealtimeStopResponse;
use ctox_app_server_protocol::ThreadResumeParams;
use ctox_app_server_protocol::ThreadResumeResponse;
use ctox_app_server_protocol::ThreadRollbackParams;
...
use ctox_app_server_protocol::ThreadStartedNotification;
use ctox_app_server_protocol::ThreadStatus;
use ctox_app_server_protocol::ThreadUnarchiveParams;
use ctox_app_server_protocol::ThreadUnarchiveResponse;
use ctox_app_server_protocol::ThreadUnarchivedNotification;
use ctox_app_server_protocol::ThreadUnsubscribeParams;
use ctox_app_server_protocol::ThreadUnsubscribeResponse;
...
use ctox_app_server_protocol::UserInput as V2UserInput;
use ctox_app_server_protocol::WindowsSandboxSetupCompletedNotification;
use ctox_app_server_protocol::WindowsSandboxSetupMode;
use ctox_app_server_protocol::WindowsSandboxSetupStartParams;
use ctox_app_server_protocol::WindowsSandboxSetupStartResponse;
use ctox_app_server_protocol::build_turns_from_rollout_items;
use ctox_arg0::Arg0DispatchPaths;
use ctox_backend_client::Client as BackendClient;
use ctox_cloud_requirements::cloud_requirements_loader;
use ctox_core::AuthManager;
use ctox_core::CodexAuth;
use ctox_core::CodexThread;
use ctox_core::Cursor as RolloutCursor;
use ctox_core::NewThread;
use ctox_core::RolloutRecorder;
use ctox_core::SessionMeta;
use ctox_core::SteerInputError;
use ctox_core::ThreadConfigSnapshot;
use ctox_core::ThreadManager;
use ctox_core::ThreadSortKey as CoreThreadSortKey;
use ctox_core::auth::AuthMode as CoreAuthMode;
use ctox_core::auth::login_with_api_key;
use ctox_core::auth::login_with_chatgpt_auth_tokens;
use ctox_core::config::Config;
use ctox_core::config::ConfigOverrides;
use ctox_core::config::NetworkProxyAuditMetadata;
use ctox_core::config::edit::ConfigEdit;
use ctox_core::config::edit::ConfigEditsBuilder;
use ctox_core::config::types::McpServerTransportConfig;
use ctox_core::config_loader::CloudRequirementsLoadError;
use ctox_core::config_loader::CloudRequirementsLoadErrorCode;
use ctox_core::config_loader::CloudRequirementsLoader;
use ctox_core::default_client::set_default_client_residency_requirement;
use ctox_core::error::CodexErr;
use ctox_core::error::Result as CodexResult;
use ctox_core::exec::ExecExpiration;
use ctox_core::exec::ExecParams;
use ctox_core::exec_env::create_env;
use ctox_core::features::FEATURES;
use ctox_core::features::Feature;
use ctox_core::features::Stage;
use ctox_core::find_archived_thread_path_by_id_str;
use ctox_core::find_thread_name_by_id;
use ctox_core::find_thread_names_by_ids;
use ctox_core::find_thread_path_by_id_str;
use ctox_core::git_info::git_diff_to_remote;
use ctox_core::mcp::auth::discover_supported_scopes;
use ctox_core::mcp::auth::resolve_oauth_scopes;
use ctox_core::mcp::collect_mcp_snapshot;
use ctox_core::mcp::group_tools_by_server;
use ctox_core::models_manager::collaboration_mode_presets::CollaborationModesConfig;
use ctox_core::parse_cursor;
use ctox_core::plugins::MarketplaceError;
use ctox_core::plugins::MarketplacePluginSourceSummary;
use ctox_core::plugins::PluginInstallError as CorePluginInstallError;
use ctox_core::plugins::PluginInstallRequest;
use ctox_core::plugins::PluginReadRequest;
use ctox_core::plugins::PluginUninstallError as CorePluginUninstallError;
use ctox_core::read_head_for_summary;
use ctox_core::read_session_meta_line;
use ctox_core::rollout_date_parts;
use ctox_core::sandboxing::SandboxPermissions;
use ctox_core::state_db::StateDbHandle;
use ctox_core::state_db::get_state_db;
use ctox_core::state_db::reconcile_rollout;
use ctox_core::windows_sandbox::WindowsSandboxLevelExt;
use ctox_core::windows_sandbox::WindowsSandboxSetupMode as CoreWindowsSandboxSetupMode;
use ctox_core::windows_sandbox::WindowsSandboxSetupRequest;
use ctox_feedback::CodexFeedback;
use ctox_protocol::ThreadId;
use ctox_protocol::config_types::CollaborationMode;
use ctox_protocol::config_types::ForcedLoginMethod;
use ctox_protocol::config_types::Personality;
use ctox_protocol::config_types::WindowsSandboxLevel;
use ctox_protocol::dynamic_tools::DynamicToolSpec as CoreDynamicToolSpec;
use ctox_protocol::items::TurnItem;
use ctox_protocol::models::ResponseItem;
use ctox_protocol::protocol::AgentStatus;
use ctox_protocol::protocol::ConversationAudioParams;
use ctox_protocol::protocol::ConversationStartParams;
use ctox_protocol::protocol::ConversationTextParams;
use ctox_protocol::protocol::EventMsg;
use ctox_protocol::protocol::GitInfo as CoreGitInfo;
use ctox_protocol::protocol::InitialHistory;
use ctox_protocol::protocol::McpAuthStatus as CoreMcpAuthStatus;
use ctox_protocol::protocol::McpServerRefreshConfig;
use ctox_protocol::protocol::Op;
use ctox_protocol::protocol::RateLimitSnapshot as CoreRateLimitSnapshot;
use ctox_protocol::protocol::ReviewDelivery as CoreReviewDelivery;
use ctox_protocol::protocol::ReviewRequest;
use ctox_protocol::protocol::ReviewTarget as CoreReviewTarget;
use ctox_protocol::protocol::RolloutItem;
use ctox_protocol::protocol::SessionConfiguredEvent;
use ctox_protocol::protocol::SessionMetaLine;
use ctox_protocol::protocol::USER_MESSAGE_BEGIN;
use ctox_protocol::protocol::W3cTraceContext;
use ctox_protocol::user_input::MAX_USER_INPUT_TEXT_CHARS;
use ctox_protocol::user_input::UserInput as CoreInputItem;
use ctox_rmcp_client::perform_oauth_login_return_url;
use ctox_state::StateRuntime;
use ctox_state::ThreadMetadataBuilder;
use ctox_state::log_db::LogDbLayer;
use ctox_utils_json_to_toml::json_to_toml;
use ctox_utils_pty::DEFAULT_OUTPUT_BYTES_CAP;
...
impl CodexMessageProcessor {
    ...
    async fn load_latest_config(
        ...
        config.ctox_linux_sandbox_exe = self.arg0_paths.ctox_linux_sandbox_exe.clone();
    ...
    fn review_request_from_target(
        ...
        let hint = ctox_core::review_prompts::user_facing_hint(&core_target);
    ...
    async fn login_api_key_v2(
        ...
        match self.login_api_key_common(&params).await {
            Ok(()) => {
                let response = ctox_app_server_protocol::LoginAccountResponse::ApiKey {};
    ...
    async fn login_chatgpt_v2(&mut self, request_id: ConnectionRequestId) {
        self.send_invalid_request_error(
            request_id,
            "Interactive ChatGPT login is not available in the CTOX inference runtime. Use API key login or account/login/start with chatgptAuthTokens.".to_string(),
        )
        .await;
    }
    ...
    async fn exec_one_off_command(
        ...
        let exec_params = ExecParams {
            ...
            network: started_network_proxy
                .as_ref()
                .map(ctox_core::config::StartedNetworkProxy::proxy),
            ...
            Some(policy) => match self.config.permissions.sandbox_policy.can_set(&policy) {
                Ok(()) => {
                    let file_system_sandbox_policy =
                        ctox_protocol::permissions::FileSystemSandboxPolicy::from_legacy_sandbox_policy(&policy, &sandbox_cwd);
                    let network_sandbox_policy =
                        ctox_protocol::permissions::NetworkSandboxPolicy::from(&policy);
        ...
        let ctox_linux_sandbox_exe = self.arg0_paths.ctox_linux_sandbox_exe.clone();
        let outgoing = self.outgoing.clone();
        ...
        match ctox_core::exec::build_exec_request(
            exec_params,
            &effective_policy,
            &effective_file_system_sandbox_policy,
            effective_network_sandbox_policy,
            sandbox_cwd.as_path(),
            &ctox_linux_sandbox_exe,
            use_legacy_landlock,
        ) {
            Ok(exec_request) => {
    ...
    async fn request_trace_context(
        &self,
        request_id: &ConnectionRequestId,
    ) -> Option<ctox_protocol::protocol::W3cTraceContext> {
    ...
    fn build_thread_config_overrides(
        ...
        service_tier: Option<Option<ctox_protocol::config_types::ServiceTier>>,
        cwd: Option<String>,
        approval_policy: Option<ctox_app_server_protocol::AskForApproval>,
        approvals_reviewer: Option<ctox_app_server_protocol::ApprovalsReviewer>,
        ...
        ConfigOverrides {
            ...
            approval_policy: approval_policy.map(ctox_app_server_protocol::AskForApproval::to_core),
            approvals_reviewer: approvals_reviewer
                .map(ctox_app_server_protocol::ApprovalsReviewer::to_core),
            sandbox_mode: sandbox.map(SandboxMode::to_core),
            ctox_linux_sandbox_exe: self.arg0_paths.ctox_linux_sandbox_exe.clone(),
    ...
    async fn thread_set_name(&self, request_id: ConnectionRequestId, params: ThreadSetNameParams) {
        ...
        let Some(name) = ctox_core::util::normalize_thread_name(&name) else {
            self.send_invalid_request_error(
                request_id,
        ...
        if let Err(err) =
            ctox_core::append_thread_name(&self.config.codex_home, thread_id, &name).await
        {
            self.send_internal_error(request_id, format!("failed to set thread name: {err}"))
                .await;
            return;
    ...
    async fn thread_unarchive(
        ...
        let archived_folder = self
            .config
            .codex_home
            .join(ctox_core::ARCHIVED_SESSIONS_SUBDIR);
        ...
        let result: Result<Thread, JSONRPCErrorError> = async {
            ...
            let sessions_folder = self.config.codex_home.join(ctox_core::SESSIONS_SUBDIR);
    ...
    async fn get_thread_summary(
        ...
        let path = match params {
            ...
            GetConversationSummaryParams::ThreadId { conversation_id } => {
                match ctox_core::find_thread_path_by_id_str(
                    &self.config.codex_home,
    ...
    async fn archive_thread_common(
        ...
        let rollout_folder = self.config.codex_home.join(ctox_core::SESSIONS_SUBDIR);
    ...
    async fn apps_list(&self, request_id: ConnectionRequestId, params: AppsListParams) {
        ...
        self.send_invalid_request_error(
            request_id,
            "App directory listing is not part of the CTOX inference runtime.".to_string(),
        )
        .await;
    }
    ...
    async fn skills_list(&self, request_id: ConnectionRequestId, params: SkillsListParams) {
        ...
        for cwd in cwds {
            ...
            data.push(ctox_app_server_protocol::SkillsListEntry {
                cwd,
                skills,
                errors,
            });
        ...
        let turn_id = self
            .submit_core_op(
                ...
                Op::UserInput {
                    ...
                    required_initial_tool: params.required_initial_tool,
                },
            )
            .await;
        ...
        tokio::spawn(async move {
            ...
            let setup_result = match derived_config {
                Ok(config) => {
                    ...
                    ctox_core::windows_sandbox::run_windows_sandbox_setup(setup_request).await
                }
...
fn collect_resume_override_mismatches(
    ...
    if let Some(requested_review_policy) = request.approvals_reviewer.as_ref() {
        let active_review_policy: ctox_app_server_protocol::ApprovalsReviewer =
    ...
    if let Some(requested_sandbox) = request.sandbox.as_ref() {
        let sandbox_matches = matches!(
            ...
            (
                ...
                ctox_protocol::protocol::SandboxPolicy::ReadOnly { .. }
            ) | (
                SandboxMode::WorkspaceWrite,
                ctox_protocol::protocol::SandboxPolicy::WorkspaceWrite { .. }
            ) | (
                SandboxMode::DangerFullAccess,
                ctox_protocol::protocol::SandboxPolicy::DangerFullAccess
            ) | (
                SandboxMode::DangerFullAccess,
                ctox_protocol::protocol::SandboxPolicy::ExternalSandbox { .. }
            )
        );
        if !sandbox_matches {
            mismatch_details.push(format!(
...
fn skills_to_info(
    skills: &[ctox_core::skills::SkillMetadata],
    disabled_paths: &std::collections::HashSet<PathBuf>,
) -> Vec<ctox_app_server_protocol::SkillMetadata> {
    skills
        .iter()
        .map(|skill| {
            let enabled = !disabled_paths.contains(&skill.path_to_skills_md);
            ctox_app_server_protocol::SkillMetadata {
                name: skill.name.clone(),
                description: skill.description.clone(),
                short_description: skill.short_description.clone(),
                interface: skill.interface.clone().map(|interface| {
                    ctox_app_server_protocol::SkillInterface {
                        display_name: interface.display_name,
                ...
                dependencies: skill.dependencies.clone().map(|dependencies| {
                    ctox_app_server_protocol::SkillDependencies {
                        tools: dependencies
                            .tools
                            .into_iter()
                            .map(|tool| ctox_app_server_protocol::SkillToolDependency {
                                r#type: tool.r#type,
                                value: tool.value,
                                description: tool.description,
...
fn plugin_skills_to_info(skills: &[ctox_core::skills::SkillMetadata]) -> Vec<SkillSummary> {
    skills
        .iter()
...
fn plugin_interface_to_info(
    interface: ctox_core::plugins::PluginManifestInterfaceSummary,
) -> PluginInterface {
    PluginInterface {
        display_name: interface.display_name,
        short_description: interface.short_description,
...
fn errors_to_info(
    errors: &[ctox_core::skills::SkillError],
) -> Vec<ctox_app_server_protocol::SkillErrorInfo> {
    errors
        .iter()
        .map(|err| ctox_app_server_protocol::SkillErrorInfo {
            path: err.path.clone(),
...
fn validate_dynamic_tools(tools: &[ApiDynamicToolSpec]) -> Result<(), String> {
    ...
    for tool in tools {
        ...
        if let Err(err) = ctox_core::parse_tool_input_schema(&tool.input_schema) {
            return Err(format!(
...
async fn sync_default_client_residency_requirement(
    ...
    let loader = cloud_requirements
        ...
        .map(|guard| guard.clone())
        .unwrap_or_default();
    match ctox_core::config::ConfigBuilder::default()
...
async fn summary_from_thread_list_item(
    ...
    if let Some(thread_id) = it.thread_id {
        ...
        let source = with_thread_spawn_agent_metadata(
            it.source
                .unwrap_or(ctox_protocol::protocol::SessionSource::Unknown),
...
fn extract_conversation_summary(
    ...
    let preview = head
        ...
        .find_map(|item| match ctox_core::parse_turn_item(&item) {
...
fn preview_from_rollout_items(items: &[RolloutItem]) -> String {
    items
        ...
        .find_map(|item| match item {
            RolloutItem::ResponseItem(item) => match ctox_core::parse_turn_item(item) {
                Some(ctox_protocol::items::TurnItem::UserMessage(user)) => Some(user.message()),
                _ => None,
            },
            _ => None,
        })
...
fn with_thread_spawn_agent_metadata(
    source: ctox_protocol::protocol::SessionSource,
    agent_nickname: Option<String>,
    agent_role: Option<String>,
) -> ctox_protocol::protocol::SessionSource {
    if agent_nickname.is_none() && agent_role.is_none() {
        return source;
    }

    match source {
        ctox_protocol::protocol::SessionSource::SubAgent(
...
mod tests {
    ...
    use anyhow::Result;
    use ctox_app_server_protocol::ServerRequestPayload;
    use ctox_app_server_protocol::ToolRequestUserInputParams;
    ...
    fn collect_resume_override_mismatches_includes_service_tier() {
        let request = ThreadResumeParams {
            ...
            model: None,
            model_provider: None,
            service_tier: Some(Some(ctox_protocol::config_types::ServiceTier::Fast)),
            cwd: None,
        ...
        let config_snapshot = ThreadConfigSnapshot {
            ...
            service_tier: Some(ctox_protocol::config_types::ServiceTier::Flex),
            approval_policy: ctox_protocol::protocol::AskForApproval::OnRequest,
    ...
    async fn removing_thread_state_clears_listener_and_active_turn_history() -> Result<()> {
            ...
            .expect("connection should be live");
        {
            ...
            state.track_current_turn_event(&EventMsg::TurnStarted(
                ctox_protocol::protocol::TurnStartedEvent {
                    turn_id: "turn-1".to_string(),
