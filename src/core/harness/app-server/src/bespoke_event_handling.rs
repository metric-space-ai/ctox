...
use ctox_app_server_protocol::AccountRateLimitsUpdatedNotification;
use ctox_app_server_protocol::AdditionalPermissionProfile as V2AdditionalPermissionProfile;
use ctox_app_server_protocol::AgentMessageDeltaNotification;
use ctox_app_server_protocol::ApplyPatchApprovalParams;
use ctox_app_server_protocol::ApplyPatchApprovalResponse;
use ctox_app_server_protocol::CodexErrorInfo as V2CodexErrorInfo;
use ctox_app_server_protocol::CollabAgentState as V2CollabAgentStatus;
use ctox_app_server_protocol::CollabAgentTool;
use ctox_app_server_protocol::CollabAgentToolCallStatus as V2CollabToolCallStatus;
use ctox_app_server_protocol::CommandAction as V2ParsedCommand;
use ctox_app_server_protocol::CommandExecutionApprovalDecision;
use ctox_app_server_protocol::CommandExecutionOutputDeltaNotification;
use ctox_app_server_protocol::CommandExecutionRequestApprovalParams;
use ctox_app_server_protocol::CommandExecutionRequestApprovalResponse;
use ctox_app_server_protocol::CommandExecutionRequestApprovalSkillMetadata;
use ctox_app_server_protocol::CommandExecutionStatus;
use ctox_app_server_protocol::ContextCompactedNotification;
use ctox_app_server_protocol::DeprecationNoticeNotification;
use ctox_app_server_protocol::DynamicToolCallOutputContentItem;
use ctox_app_server_protocol::DynamicToolCallParams;
use ctox_app_server_protocol::DynamicToolCallStatus;
use ctox_app_server_protocol::ErrorNotification;
use ctox_app_server_protocol::ExecCommandApprovalParams;
use ctox_app_server_protocol::ExecCommandApprovalResponse;
use ctox_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use ctox_app_server_protocol::FileChangeApprovalDecision;
use ctox_app_server_protocol::FileChangeOutputDeltaNotification;
use ctox_app_server_protocol::FileChangeRequestApprovalParams;
use ctox_app_server_protocol::FileChangeRequestApprovalResponse;
use ctox_app_server_protocol::FileUpdateChange;
use ctox_app_server_protocol::GrantedPermissionProfile as V2GrantedPermissionProfile;
use ctox_app_server_protocol::GuardianApprovalReview;
...
use ctox_app_server_protocol::ItemStartedNotification;
use ctox_app_server_protocol::JSONRPCErrorError;
use ctox_app_server_protocol::McpServerElicitationAction;
use ctox_app_server_protocol::McpServerElicitationRequestParams;
use ctox_app_server_protocol::McpServerElicitationRequestResponse;
use ctox_app_server_protocol::McpToolCallError;
use ctox_app_server_protocol::McpToolCallResult;
use ctox_app_server_protocol::McpToolCallStatus;
use ctox_app_server_protocol::ModelReroutedNotification;
use ctox_app_server_protocol::NetworkApprovalContext as V2NetworkApprovalContext;
use ctox_app_server_protocol::NetworkPolicyAmendment as V2NetworkPolicyAmendment;
use ctox_app_server_protocol::NetworkPolicyRuleAction as V2NetworkPolicyRuleAction;
use ctox_app_server_protocol::PatchApplyStatus;
use ctox_app_server_protocol::PermissionsRequestApprovalParams;
use ctox_app_server_protocol::PermissionsRequestApprovalResponse;
use ctox_app_server_protocol::PlanDeltaNotification;
use ctox_app_server_protocol::RawResponseItemCompletedNotification;
use ctox_app_server_protocol::ReasoningSummaryPartAddedNotification;
use ctox_app_server_protocol::ReasoningSummaryTextDeltaNotification;
use ctox_app_server_protocol::ReasoningTextDeltaNotification;
...
use ctox_app_server_protocol::SkillsChangedNotification;
use ctox_app_server_protocol::TerminalInteractionNotification;
use ctox_app_server_protocol::ThreadItem;
use ctox_app_server_protocol::ThreadNameUpdatedNotification;
use ctox_app_server_protocol::ThreadRealtimeClosedNotification;
use ctox_app_server_protocol::ThreadRealtimeErrorNotification;
use ctox_app_server_protocol::ThreadRealtimeItemAddedNotification;
use ctox_app_server_protocol::ThreadRealtimeOutputAudioDeltaNotification;
use ctox_app_server_protocol::ThreadRealtimeStartedNotification;
use ctox_app_server_protocol::ThreadRollbackResponse;
use ctox_app_server_protocol::ThreadTokenUsage;
use ctox_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use ctox_app_server_protocol::ToolRequestUserInputOption;
use ctox_app_server_protocol::ToolRequestUserInputParams;
use ctox_app_server_protocol::ToolRequestUserInputQuestion;
use ctox_app_server_protocol::ToolRequestUserInputResponse;
...
use ctox_app_server_protocol::convert_patch_changes;
use ctox_core::CodexThread;
use ctox_core::ThreadManager;
use ctox_core::find_thread_name_by_id;
use ctox_core::review_format::format_review_findings_block;
use ctox_core::review_prompts;
use ctox_core::sandboxing::intersect_permission_profiles;
use ctox_protocol::ThreadId;
use ctox_protocol::dynamic_tools::DynamicToolCallOutputContentItem as CoreDynamicToolCallOutputContentItem;
use ctox_protocol::dynamic_tools::DynamicToolResponse as CoreDynamicToolResponse;
use ctox_protocol::plan_tool::UpdatePlanArgs;
use ctox_protocol::protocol::ApplyPatchApprovalRequestEvent;
use ctox_protocol::protocol::CodexErrorInfo as CoreCodexErrorInfo;
use ctox_protocol::protocol::Event;
use ctox_protocol::protocol::EventMsg;
use ctox_protocol::protocol::ExecApprovalRequestEvent;
use ctox_protocol::protocol::ExecCommandEndEvent;
use ctox_protocol::protocol::GuardianAssessmentEvent;
use ctox_protocol::protocol::McpToolCallBeginEvent;
use ctox_protocol::protocol::McpToolCallEndEvent;
use ctox_protocol::protocol::Op;
use ctox_protocol::protocol::RealtimeEvent;
use ctox_protocol::protocol::ReviewDecision;
use ctox_protocol::protocol::ReviewOutputEvent;
use ctox_protocol::protocol::TokenCountEvent;
use ctox_protocol::protocol::TurnDiffEvent;
use ctox_protocol::request_permissions::PermissionGrantScope as CorePermissionGrantScope;
use ctox_protocol::request_permissions::RequestPermissionProfile as CoreRequestPermissionProfile;
use ctox_protocol::request_permissions::RequestPermissionsResponse as CoreRequestPermissionsResponse;
use ctox_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use ctox_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
use ctox_shell_command::parse_command::shlex_join;
...
fn guardian_auto_approval_review_notification(
    ...
    let review = GuardianApprovalReview {
        status: match assessment.status {
            ctox_protocol::protocol::GuardianAssessmentStatus::InProgress => {
                GuardianApprovalReviewStatus::InProgress
            }
            ctox_protocol::protocol::GuardianAssessmentStatus::Approved => {
                GuardianApprovalReviewStatus::Approved
            }
            ctox_protocol::protocol::GuardianAssessmentStatus::Denied => {
                GuardianApprovalReviewStatus::Denied
            }
            ctox_protocol::protocol::GuardianAssessmentStatus::Aborted => {
    ...
    match msg {
                    ...
                    Err(err) => {
                        ...
                        if let Err(err) = conversation
                            .submit(Op::ResolveElicitation {
                                ...
                                request_id: request.id,
                                decision: ctox_protocol::approvals::ElicitationAction::Cancel,
                                content: None,
                                meta: None,
                            })
                            .await
        ...
        EventMsg::CollabAgentSpawnEnd(end_event) => {
            ...
            let status = match &end_event.status {
                ctox_protocol::protocol::AgentStatus::Errored(_)
                | ctox_protocol::protocol::AgentStatus::NotFound => V2CollabToolCallStatus::Failed,
        ...
        EventMsg::CollabWaitingEnd(end_event) => {
            let status = if end_event.statuses.values().any(|status| {
                matches!(
                    status,
                    ctox_protocol::protocol::AgentStatus::Errored(_)
                        | ctox_protocol::protocol::AgentStatus::NotFound
                )
            }) {
        ...
        EventMsg::AgentMessageContentDelta(event) => {
            let ctox_protocol::protocol::AgentMessageContentDeltaEvent { item_id, delta, .. } =
                event;
...
async fn maybe_emit_raw_response_item_completed(
    ...
    conversation_id: ThreadId,
    turn_id: &str,
    item: ctox_protocol::models::ResponseItem,
    outgoing: &ThreadScopedOutgoingMessageSender,
) {
...
async fn on_mcp_server_elicitation_response(
    server_name: String,
    request_id: ctox_protocol::mcp::RequestId,
    pending_request_id: RequestId,
    receiver: oneshot::Receiver<ClientRequestResult>,
    conversation: Arc<CodexThread>,
    thread_state: Arc<Mutex<ThreadState>>,
    ...
    let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(value)
        .unwrap_or_else(|err| {
            ...
            PermissionsRequestApprovalResponse {
                ...
                scope: ctox_app_server_protocol::PermissionGrantScope::Turn,
            }
        });
...
fn collab_resume_begin_item(
    begin_event: ctox_protocol::protocol::CollabResumeBeginEvent,
) -> ThreadItem {
...
fn collab_resume_end_item(end_event: ctox_protocol::protocol::CollabResumeEndEvent) -> ThreadItem {
    let status = match &end_event.status {
        ctox_protocol::protocol::AgentStatus::Errored(_)
        | ctox_protocol::protocol::AgentStatus::NotFound => V2CollabToolCallStatus::Failed,
        _ => V2CollabToolCallStatus::Completed,
...
mod tests {
    ...
    use ctox_app_server_protocol::GuardianApprovalReviewStatus;
    use ctox_app_server_protocol::JSONRPCErrorError;
    use ctox_app_server_protocol::TurnPlanStepStatus;
    use ctox_protocol::mcp::CallToolResult;
    use ctox_protocol::models::FileSystemPermissions as CoreFileSystemPermissions;
    use ctox_protocol::models::NetworkPermissions as CoreNetworkPermissions;
    use ctox_protocol::plan_tool::PlanItemArg;
    use ctox_protocol::plan_tool::StepStatus;
    use ctox_protocol::protocol::CollabResumeBeginEvent;
    use ctox_protocol::protocol::CollabResumeEndEvent;
    use ctox_protocol::protocol::CreditsSnapshot;
    use ctox_protocol::protocol::McpInvocation;
    use ctox_protocol::protocol::RateLimitSnapshot;
    use ctox_protocol::protocol::RateLimitWindow;
    use ctox_protocol::protocol::TokenUsage;
    use ctox_protocol::protocol::TokenUsageInfo;
    ...
    fn guardian_assessment_started_uses_event_turn_id_fallback() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                id: "item-1".to_string(),
                turn_id: String::new(),
                status: ctox_protocol::protocol::GuardianAssessmentStatus::InProgress,
                risk_score: None,
                risk_level: None,
                rationale: None,
    ...
    fn guardian_assessment_completed_emits_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: ctox_protocol::protocol::GuardianAssessmentStatus::Denied,
                risk_score: Some(91),
                risk_level: Some(ctox_protocol::protocol::GuardianRiskLevel::High),
        ...
        match notification {
            ServerNotification::ItemGuardianApprovalReviewCompleted(payload) => {
                ...
                assert_eq!(
                    ...
                    Some(ctox_app_server_protocol::GuardianRiskLevel::High)
                );
    ...
    fn guardian_assessment_aborted_emits_completed_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                id: "item-3".to_string(),
                turn_id: "turn-from-assessment".to_string(),
                status: ctox_protocol::protocol::GuardianAssessmentStatus::Aborted,
                risk_score: None,
                risk_level: None,
                rationale: None,
                action: Some(action.clone()),
    ...
    fn collab_resume_end_maps_to_item_completed_resume_agent() {
        let event = CollabResumeEndEvent {
            ...
            receiver_agent_nickname: None,
            receiver_agent_role: None,
            status: ctox_protocol::protocol::AgentStatus::NotFound,
        };
        ...
        let expected = ThreadItem::CollabAgentToolCall {
            ...
            agents_states: [(
                receiver_id,
                V2CollabAgentStatus::from(ctox_protocol::protocol::AgentStatus::NotFound),
            )]
            .into_iter()
            .collect(),
        };
