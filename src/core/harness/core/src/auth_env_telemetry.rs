use ctox_otel::AuthEnvTelemetryMetadata;
...
pub(crate) struct AuthEnvTelemetry {
    ...
    pub(crate) ctox_api_key_env_present: bool,
    pub(crate) ctox_api_key_env_enabled: bool,
...
impl AuthEnvTelemetry {
    pub(crate) fn to_otel_metadata(&self) -> AuthEnvTelemetryMetadata {
        AuthEnvTelemetryMetadata {
            ...
            ctox_api_key_env_present: self.ctox_api_key_env_present,
            ctox_api_key_env_enabled: self.ctox_api_key_env_enabled,
...
pub(crate) fn collect_auth_env_telemetry(
    ...
    ctox_api_key_env_enabled: bool,
) -> AuthEnvTelemetry {
    AuthEnvTelemetry {
        openai_api_key_env_present: env_var_present(OPENAI_API_KEY_ENV_VAR),
        ctox_api_key_env_present: env_var_present(CODEX_API_KEY_ENV_VAR),
        ctox_api_key_env_enabled,
