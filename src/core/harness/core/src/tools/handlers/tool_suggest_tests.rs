...
#[test]
fn filter_tool_suggest_discoverable_tools_for_ctox_tui_omits_plugins() {
    ...
    assert_eq!(
        filter_tool_suggest_discoverable_tools_for_client(discoverable_tools, Some("ctox-tui"),),
