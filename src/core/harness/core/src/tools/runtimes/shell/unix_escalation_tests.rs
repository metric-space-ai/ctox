...
use ctox_execpolicy::PolicyParser;
...
use ctox_protocol::models::MacOsPreferencesPermission;
...
async fn prepare_escalated_exec_permissions_preserve_macos_seatbelt_extensions() {
    ...
    let permissions = Permissions {
        ...
        file_system_sandbox_policy: read_only_file_system_sandbox_policy(),
        network_sandbox_policy: ctox_protocol::permissions::NetworkSandboxPolicy::Restricted,
        network: None,
