...
use ctox_protocol::models::ReasoningItemContent;
use ctox_protocol::models::ReasoningItemReasoningSummary;
use ctox_protocol::models::ResponseItem;
use ctox_protocol::models::WebSearchAction;
use ctox_protocol::models::is_image_close_tag_text;
use ctox_protocol::models::is_image_open_tag_text;
use ctox_protocol::models::is_local_image_close_tag_text;
use ctox_protocol::models::is_local_image_open_tag_text;
...
pub fn parse_turn_item(item: &ResponseItem) -> Option<TurnItem> {
    match item {
        ...
        ResponseItem::ImageGenerationCall {
            ...
            ctox_protocol::items::ImageGenerationItem {
                id: id.clone(),
                status: status.clone(),
