...
use ctox_protocol::protocol::HookCompletedEvent;
use ctox_protocol::protocol::HookEventName;
use ctox_protocol::protocol::HookExecutionMode;
use ctox_protocol::protocol::HookHandlerType;
use ctox_protocol::protocol::HookRunStatus;
use ctox_protocol::protocol::HookRunSummary;
use ctox_protocol::protocol::HookScope;
...
pub(crate) fn completed_summary(
    ...
    entries: Vec<ctox_protocol::protocol::HookOutputEntry>,
) -> HookRunSummary {
    HookRunSummary {
        id: handler.run_id(),
        event_name: handler.event_name,
