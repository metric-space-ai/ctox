...
use ctox_config::ConfigLayerStack;
use ctox_config::ConfigLayerStackOrdering;
use regex::Regex;
    ...
    for layer in config_layer_stack.get_layers(
        ...
        for group in parsed.hooks.session_start {
            append_group_handlers(
                ...
                &mut display_order,
                source_path.as_path(),
                ctox_protocol::protocol::HookEventName::SessionStart,
        ...
        for group in parsed.hooks.stop {
            append_group_handlers(
                ...
                &mut display_order,
                source_path.as_path(),
                ctox_protocol::protocol::HookEventName::Stop,
                /*matcher*/ None,
                group.hooks,
            );
        }
...
fn append_group_handlers(
    ...
    source_path: &Path,
    event_name: ctox_protocol::protocol::HookEventName,
    matcher: Option<&str>,
