...
//! the matching server binary under `src/core/inference/models/<model>/`
...
mod tests {
    ...
    fn qwen36_backend_assembles_expected_cli() {
        ...
        assert!(backend.binary.ends_with(
            "src/core/inference/models/qwen36_35b_a3b_ggml/target/release/qwen36-35b-a3b-ggml-server"
        ));
    }
