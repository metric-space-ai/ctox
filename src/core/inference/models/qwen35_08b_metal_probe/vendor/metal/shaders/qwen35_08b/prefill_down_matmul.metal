...
kernel void qwen35_08b_prefill_down_matmul_rowtiles_tok2_fp16_tiled_k3584_f32(
...
kernel void qwen35_08b_prefill_down_matmul_rowtiles_tok4_simd_fp16_tiled_k3584_f32(
    device const half* x_tokens [[buffer(0)]],
    device const half* w_tiled [[buffer(1)]],
    device float* y_tokens [[buffer(2)]],
    constant uint& tokens [[buffer(3)]],
...
kernel void qwen35_08b_prefill_down_matmul_residual_rowtiles_tok4_simd_fp16_tiled_k3584(
    device const half* x_tokens [[buffer(0)]],
    device const half* w_tiled [[buffer(1)]],
...
kernel void qwen35_08b_prefill_down_matmul_rowtiles_tok8_simd_fp16_tiled_k3584_f32(
    device const half* x_tokens [[buffer(0)]],
    device const half* w_tiled [[buffer(1)]],
    device float* y_tokens [[buffer(2)]],
    constant uint& tokens [[buffer(3)]],
