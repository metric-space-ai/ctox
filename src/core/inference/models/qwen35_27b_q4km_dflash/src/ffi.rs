...
extern "C" {
    pub fn gguf_init_from_file(fname: *const c_char, params: gguf_init_params) -> *mut gguf_context;
...
const _: () = {
    assert!(std::mem::size_of::<ggml_init_params>() == 24 || std::mem::size_of::<ggml_init_params>() == 16);
