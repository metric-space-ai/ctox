...
const modeEvidenceRequirements = {
  ...
  'business-os-ui-regression': {
    ...
    values: {
      ...
      business_os_ui_secondary_opened_modules: 'matching,conversations,outbound,shiftflow,buchhaltung,coding-agents',
      business_os_ui_secondary_rendered_modules: 'matching,conversations,outbound,shiftflow,buchhaltung,coding-agents',
      business_os_ui_secondary_interacted_modules: 'matching,conversations,outbound,shiftflow,buchhaltung,coding-agents',
      business_os_ui_secondary_interaction_names: 'matching-list-matrix-tabs,conversations-channel-filter,outbound-outreach-toggle,shiftflow-center-tabs,buchhaltung-nav-switch,coding-agents-settings-modal',
