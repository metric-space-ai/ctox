...
const businessOsProductionSmokeEvidenceRequirements = Object.freeze({
  ...
  'business-os-threads-rightclick-ui': freezeRequirement({
    keys: [
      'business_os_threads_rightclick_target_module',
      'business_os_threads_rightclick_reviewer_id',
      'business_os_threads_rightclick_thread_id',
      'business_os_threads_rightclick_data_approval_command_persisted',
      'business_os_threads_rightclick_direct_denial_command_id',
      'business_os_threads_rightclick_direct_denial_reason',
      'business_os_threads_rightclick_ask_command_persisted',
      'business_os_threads_rightclick_app_approval_command_persisted',
      'business_os_threads_rightclick_source_context_captured',
      'business_os_threads_rightclick_reviewer_picker_visible',
      'business_os_threads_rightclick_approval_decision',
      'business_os_threads_rightclick_approved_command_id',
      'business_os_threads_rightclick_approved_command_status',
      'business_os_threads_rightclick_reauthorization_linked',
      'business_os_threads_rightclick_actor_role',
      'business_os_threads_rightclick_reviewer_role',
      'business_os_threads_rightclick_auth_state',
      'business_os_threads_rightclick_browser_context',
      'business_os_threads_rightclick_tenant_scope',
      'advanced_status',
    ],
    values: {
      business_os_threads_rightclick_data_approval_command_persisted: 1,
      business_os_threads_rightclick_direct_denial_reason: 'role_or_scope_denied',
      business_os_threads_rightclick_ask_command_persisted: 1,
      business_os_threads_rightclick_app_approval_command_persisted: 1,
      business_os_threads_rightclick_source_context_captured: 1,
      business_os_threads_rightclick_reviewer_picker_visible: 1,
      business_os_threads_rightclick_approval_decision: 'approved',
      business_os_threads_rightclick_reauthorization_linked: 1,
      business_os_threads_rightclick_auth_state: 'authenticated',
      business_os_threads_rightclick_browser_context: 'clean',
      business_os_threads_rightclick_tenant_scope: 'local-workspace',
      advanced_status: 'business-os-advanced-status-v1',
    },
  }),
  'business-os-threads-scale-ui': freezeRequirement({
    keys: [
      'business_os_threads_scale_commands',
      'business_os_threads_scale_threads',
      'business_os_threads_scale_messages',
      'business_os_threads_scale_notifications',
      'business_os_threads_scale_visible_thread_rows',
      'business_os_threads_scale_first_render_ms',
      'business_os_threads_scale_budget_passed',
      'business_os_threads_scale_auth_state',
      'business_os_threads_scale_actor_role',
      'business_os_threads_scale_browser_context',
      'business_os_threads_scale_tenant_scope',
      'advanced_status',
    ],
    values: {
      business_os_threads_scale_budget_passed: 1,
      business_os_threads_scale_auth_state: 'authenticated',
      business_os_threads_scale_actor_role: 'admin',
      business_os_threads_scale_browser_context: 'clean',
      business_os_threads_scale_tenant_scope: 'local-workspace',
      advanced_status: 'business-os-advanced-status-v1',
    },
    minimums: {
      ...
      business_os_threads_scale_visible_thread_rows: 1,
    },
    maximums: {
      business_os_threads_scale_visible_thread_rows: 200,
      business_os_threads_scale_first_render_ms: 30000,
    },
  }),
