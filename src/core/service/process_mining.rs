...
fn upsert_default_core_transition_rules(conn: &Connection) -> Result<()> {
    ...
    let defaults = [
        ...
        (
            "ctox-harness-flow-events-telemetry",
            826,
            Some("=ctox_harness_flow_events"),
            None,
            None,
            None,
            "telemetry",
        ...
        (
            "summary-messages-telemetry",
            828,
            Some("=summary_messages"),
            None,
            None,
            None,
            "telemetry",
            "SummaryMessages",
            "P1RuntimeSafety",
            "telemetry.summary_messages",
            json!({"core_transition": false}),
        ),
        (
            "summary-edges-telemetry",
            829,
            Some("=summary_edges"),
            None,
            None,
