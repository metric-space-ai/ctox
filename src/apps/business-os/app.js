...
const APP_BUILD = '20260526-subscription-device2';
...
async function loadBusinessDbModule() {
  if (!businessDbModulePromise) {
    businessDbModulePromise = importBusinessOsModule('./shared/db.js?v=20260526-subscription-device2', 'business db')
      .then((mod) => {
...
async function loadSyncModule() {
  if (!syncModulePromise) {
    syncModulePromise = importBusinessOsModule('./shared/sync.js?v=20260526-subscription-device2', 'business sync')
      .then((mod) => {
        syncModule = mod;
        return mod;
      });
...
async function loadReactSettingsModule() {
  if (!reactSettingsModulePromise) {
    reactSettingsModulePromise = importBusinessOsModule('./shared/react-settings.js?v=20260526-subscription-device2', 'react settings');
  }
