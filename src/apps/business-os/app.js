import { subscriptionModelUnavailable } from './shared/model-access-health.js?v=20260923-control-plane-swr-warm-reload-v385';
import { CtoxResizer } from './shared/resizer.js?v=20260923-control-plane-swr-warm-reload-v385';
import { collectionReadinessFromDiagnostics } from './shared/sync-contract.js?v=20260923-control-plane-swr-warm-reload-v385';
import { autoWirePaneGrammar } from './shared/pane-grammar.js?v=20260923-control-plane-swr-warm-reload-v385';
import { createAppActions } from './shared/app-actions.js?v=20260923-control-plane-swr-warm-reload-v385';
import {
  appLifecycleBadge,
  appLifecycleState,
...
} from './shared/app-lifecycle.js?v=20260923-control-plane-swr-warm-reload-v385';
import {
...
} from './shared/permissions.js?v=20260923-control-plane-swr-warm-reload-v385';
import {
  applyWorkspaceBranding,
  brandingForPreferencePayload,
  WORKSPACE_BRANDING_COLLECTION,
  WORKSPACE_BRANDING_DOCUMENT_ID,
} from './shared/branding.js?v=20260923-control-plane-swr-warm-reload-v385';
import { normalizeRole, roleCanManage, roleDescription, roleDisplayName } from './shared/roles.js?v=20260923-control-plane-swr-warm-reload-v385';
import {
  launchesInWindow,
  resolvePresentation,
  resolveShellWindowContract,
  usesLegacyWorkspace,
} from './shared/presentation.js?v=20260923-control-plane-swr-warm-reload-v385';
import {
...
} from './shared/shell-permissions-ui.js?v=20260923-control-plane-swr-warm-reload-v385';
import { createShellChatCompositionController } from './shared/shell-chat-composition.js?v=20260923-control-plane-swr-warm-reload-v385';
import { createDocumentsFacade } from './shared/documents.js?v=20260923-control-plane-swr-warm-reload-v385';
import {
...
} from './shared/maintenance-state.js?v=20260923-control-plane-swr-warm-reload-v385';
import {
  buildWorkspaceSessionSnapshot,
  normalizeWorkspaceSessionSnapshot,
} from './shared/workspace-session.js?v=20260923-control-plane-swr-warm-reload-v385';
import {
  decodeTaskbarPinCache,
  encodeTaskbarPinCache,
  resolveTaskbarPinState,
} from './shared/taskbar-pins.js?v=20260923-control-plane-swr-warm-reload-v385';
import {
...
import { operatorIconFor } from './shared/operator-icon-selection.js?v=20260923-control-plane-swr-warm-reload-v385';
import { resolveLauncherIcon } from './shared/launcher-icon.js?v=20260923-control-plane-swr-warm-reload-v385';
import { createShellGenerationReloadGuard } from './shared/shell-generation.js?v=20260923-control-plane-swr-warm-reload-v385';
import {
  ...
  withStartupDeadline,
} from './shared/startup-deadlines.js?v=20260923-control-plane-swr-warm-reload-v385';
import { createBusinessCompanionScheduler } from './shared/business-companions.js?v=20260923-control-plane-swr-warm-reload-v385';
...
const APP_BUILD = '20260923-control-plane-swr-warm-reload-v385';
