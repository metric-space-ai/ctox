...
} from './sync-contract.js?v=20260909-crew-card-status-v368';
import { getBusinessOsCapabilityToken } from './command-bus.js?v=20260909-crew-card-status-v368';
import { loadRxdbRuntime, RXDB_BUNDLE_URL } from './rxdb-runtime.js?v=20260909-crew-card-status-v368';
...
const MULTI_TAB_COORDINATOR_EPOCH = '20260909-crew-card-status-v368';
