...
} from './sync-contract.js?v=20260910-shell-v2-chat-inspection-row-v375';
import { getBusinessOsCapabilityToken } from './command-bus.js?v=20260910-shell-v2-chat-inspection-row-v375';
import { loadRxdbRuntime, RXDB_BUNDLE_URL } from './rxdb-runtime.js?v=20260910-shell-v2-chat-inspection-row-v375';
...
const MULTI_TAB_COORDINATOR_EPOCH = '20260910-shell-v2-chat-inspection-row-v375';
