...
console.log("=== HyperFormula BUNDLE ESM Port Test Suite ===");
...
try {
  ...
  console.log("\n🎉 ALL BUNDLE TESTS PASSED SUCCESSFULLY! The compiled hyperformula.mjs bundle is 100% correct! 🎉");
} catch (e) {
  console.error("\n❌ BUNDLE TEST SUITE RUN ENCOUNTERED AN ERROR:", e);
  process.exit(1);
}
