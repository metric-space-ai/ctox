...
// src/apps/business-os/office-engine/src/document.mjs
function createCtoxDocumentsEditor(options = {}) {
  return createCtoxOfficeEditor({ ...options, kind: "document" });
}
var createCtoxOfficeEditor2 = createCtoxDocumentsEditor;
var CTOX_DOCUMENTS_EDITOR_KIND = "document";
var CTOX_DOCUMENTS_PRODUCT_ID = "ctox-documents";
var CTOX_OFFICE_EDITOR_KIND = CTOX_DOCUMENTS_EDITOR_KIND;
export {
  CTOX_DOCUMENTS_EDITOR_KIND,
  CTOX_DOCUMENTS_PRODUCT_ID,
  CTOX_OFFICE_EDITOR_KIND,
  createCtoxDocumentsEditor,
