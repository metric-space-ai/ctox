...
const spreadsheetVersionSchema = {
  version: 0,
  primaryKey: 'id',
  type: 'object',
  properties: {
  ...
  required: ['id', 'spreadsheet_id', 'version', 'source_kind', 'blob_id', 'model_json', 'diagnostics', 'created_at_ms', 'updated_at_ms'],
  additionalProperties: true
};

const spreadsheetBlobChunkSchema = {
  version: 0,
  primaryKey: 'id',
  type: 'object',
  properties: {
  ...
  required: ['id', 'blob_id', 'spreadsheet_id', 'version_id', 'idx', 'total', 'mime_type', 'encoding', 'data', 'created_at_ms'],
  additionalProperties: false
};

const spreadsheetRunbookSchema = {
  version: 0,
  primaryKey: 'id',
  type: 'object',
  properties: {
...
export const collections = {
  ...
  spreadsheet_versions: spreadsheetVersionSchema,
  spreadsheet_blob_chunks: spreadsheetBlobChunkSchema,
  spreadsheet_runbooks: spreadsheetRunbookSchema
};
