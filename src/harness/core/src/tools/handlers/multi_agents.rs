...
use ctox_protocol::protocol::CollabAgentInteractionBeginEvent;
use ctox_protocol::protocol::CollabAgentInteractionEndEvent;
use ctox_protocol::protocol::CollabAgentRef;
use ctox_protocol::protocol::CollabAgentSpawnBeginEvent;
use ctox_protocol::protocol::CollabAgentSpawnEndEvent;
use ctox_protocol::protocol::CollabAgentStatusEntry;
use ctox_protocol::protocol::CollabCloseBeginEvent;
use ctox_protocol::protocol::CollabCloseEndEvent;
use ctox_protocol::protocol::CollabResumeBeginEvent;
use ctox_protocol::protocol::CollabResumeEndEvent;
use ctox_protocol::protocol::CollabWaitingBeginEvent;
use ctox_protocol::protocol::CollabWaitingEndEvent;
...
fn apply_spawn_agent_runtime_overrides(
    ...
    config.ctox_linux_sandbox_exe = turn.ctox_linux_sandbox_exe.clone();
...
fn find_spawn_agent_model_name(
    available_models: &[ctox_protocol::openai_models::ModelPreset],
    requested_model: &str,
