...
//!
//! This crate wraps [`ctox_app_server::in_process`] behind a single async API
...
//! [`InProcessClientHandle`](ctox_app_server::in_process::InProcessClientHandle),
...
use ctox_app_server_protocol::InitializeCapabilities;
...
use ctox_app_server_protocol::Result as JsonRpcResult;
...
impl InProcessClientStartArgs {
    ...
    fn into_runtime_start_args(self, shared_core: &SharedCoreManagers) -> InProcessStartArgs {
        ...
        InProcessStartArgs {
            ...
            enable_ctox_api_key_env: self.enable_ctox_api_key_env,
            initialize,
...
/// - [`ctox_app_server::in_process::InProcessClientHandle`], which speaks to
...
impl InProcessAppServerClient {
    ...
    pub async fn start(args: InProcessClientStartArgs) -> IoResult<Self> {
        ...
        let mut handle =
            ctox_app_server::in_process::start(args.into_runtime_start_args(&shared_core)).await?;
...
mod tests {
    ...
    use ctox_app_server_protocol::JSONRPCMessage;
    ...
    async fn start_test_client_with_capacity(
        ...
        InProcessAppServerClient::start(InProcessClientStartArgs {
            ...
            client_name: "ctox-app-server-client-test".to_string(),
    ...
    async fn typed_request_reports_json_rpc_errors() {
        ...
        let err = client
            .request_typed::<ConfigRequirementsReadResponse>(ClientRequest::ThreadRead {
                ...
                params: ctox_app_server_protocol::ThreadReadParams {
    ...
    async fn shared_thread_manager_tracks_threads_started_via_app_server() {
        ...
        let response: ThreadStartResponse = client
            ...
            .await
            .expect("thread/start should succeed");
        let created_thread_id = ctox_protocol::ThreadId::from_string(&response.thread.id)
    ...
    async fn remote_typed_request_roundtrip_works() {
        ...
        let response: GetAccountResponse = client
            .request_typed(ClientRequest::GetAccount {
                request_id: RequestId::Integer(1),
                params: ctox_app_server_protocol::GetAccountParams {
                    refresh_token: false,
                },
            })
            .await
    ...
    fn event_requires_delivery_marks_terminal_events() {
        assert!(event_requires_delivery(
            &InProcessServerEvent::ServerNotification(
                ctox_app_server_protocol::ServerNotification::TurnCompleted(
                    ctox_app_server_protocol::TurnCompletedNotification {
                        thread_id: "thread".to_string(),
                        turn: ctox_app_server_protocol::Turn {
                            id: "turn".to_string(),
                            items: Vec::new(),
                            status: ctox_app_server_protocol::TurnStatus::Completed,
                            error: None,
                        },
                    }
                )
