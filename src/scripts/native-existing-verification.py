...
FILTERS = ['coding_agents::pi_sidecar::', 'reply_capture::tests',
           ...
           'business_control_concurrent_claim_preserves_single_owner',
           'business_command_concurrent_worker_result_preserves_immutable_attempt',
           'business_control_claim_suppresses_uncertain_replay_and_returns_terminal_result',
           'business_command_cannot_complete_before_typed_result_review_and_validation',
           'review_rework_reuses_task_and_increments_attempt',
           'typed_result_persistence_hold_retries_command_and_queue_together',
...
def main():
    ...
    expected_counts = {
        ...
        'business_control_concurrent_claim_preserves_single_owner': 1,
        'business_command_concurrent_worker_result_preserves_immutable_attempt': 1,
        'business_control_claim_suppresses_uncertain_replay_and_returns_terminal_result': 1,
        'business_command_cannot_complete_before_typed_result_review_and_validation': 1,
        'review_rework_reuses_task_and_increments_attempt': 1,
        'typed_result_persistence_hold_retries_command_and_queue_together': 1,
