...
def main() -> int:
    parser = argparse.ArgumentParser(description="Query recovery_assurance state from the shared SQLite kernel.")
    ...
    if args.command == "summary":
        print(json.dumps(shared.summary(conn, "recovery_assurance"), indent=2))
        return 0
    print(json.dumps(shared.export_cytoscape(conn, "recovery_assurance"), indent=2))
    return 0
