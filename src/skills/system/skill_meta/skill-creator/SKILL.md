...
For CTOX mission work, generated skill files are not durable knowledge by themselves. The operational learning only becomes durable when it is reflected into CTOX runtime store, knowledge records, or bindings.
