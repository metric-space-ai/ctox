...
Review learnings only count as durable knowledge when they are reflected in the the CTOX runtime store, such as verifications, continuity, ticket knowledge, or other runtime store records. Standalone notes do not count as durable knowledge by themselves.
