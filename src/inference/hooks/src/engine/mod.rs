...
pub(crate) struct ConfiguredHandler {
    pub event_name: ctox_protocol::protocol::HookEventName,
...
impl ConfiguredHandler {
    ...
    fn event_name_label(&self) -> &'static str {
        match self.event_name {
            ctox_protocol::protocol::HookEventName::SessionStart => "session-start",
            ctox_protocol::protocol::HookEventName::Stop => "stop",
        }
    }
}
