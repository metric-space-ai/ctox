...
use ctox_api::ApiError;
use ctox_api::ResponseEvent;
...
pub struct AuthEnvTelemetryMetadata {
    ...
    pub ctox_api_key_env_present: bool,
    pub ctox_api_key_env_enabled: bool,
    ...
    pub fn conversation_starts(
        ...
        log_and_trace_event!(
            ...
            common: {
                ...
                auth.env_ctox_api_key_present = self.metadata.auth_env.ctox_api_key_env_present,
                auth.env_ctox_api_key_enabled = self.metadata.auth_env.ctox_api_key_env_enabled,
