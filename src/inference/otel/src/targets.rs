pub(crate) const OTEL_TARGET_PREFIX: &str = "ctox_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "ctox_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "ctox_otel.trace_safe";
