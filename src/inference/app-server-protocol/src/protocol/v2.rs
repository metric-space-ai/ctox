...
use ctox_experimental_api_macros::ExperimentalApi;
use ctox_protocol::account::PlanType;
use ctox_protocol::approvals::ElicitationRequest as CoreElicitationRequest;
use ctox_protocol::approvals::ExecApprovalRequestSkillMetadata as CoreExecApprovalRequestSkillMetadata;
use ctox_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use ctox_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use ctox_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use ctox_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use ctox_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use ctox_protocol::config_types::ApprovalsReviewer as CoreApprovalsReviewer;
use ctox_protocol::config_types::CollaborationMode;
use ctox_protocol::config_types::CollaborationModeMask as CoreCollaborationModeMask;
...
use ctox_protocol::config_types::SandboxMode as CoreSandboxMode;
use ctox_protocol::config_types::ServiceTier;
use ctox_protocol::config_types::Verbosity;
use ctox_protocol::config_types::WebSearchMode;
use ctox_protocol::config_types::WebSearchToolConfig;
use ctox_protocol::items::AgentMessageContent as CoreAgentMessageContent;
use ctox_protocol::items::TurnItem as CoreTurnItem;
use ctox_protocol::mcp::Resource as McpResource;
use ctox_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use ctox_protocol::mcp::Tool as McpTool;
use ctox_protocol::models::FileSystemPermissions as CoreFileSystemPermissions;
use ctox_protocol::models::MacOsAutomationPermission as CoreMacOsAutomationPermission;
use ctox_protocol::models::MacOsContactsPermission as CoreMacOsContactsPermission;
use ctox_protocol::models::MacOsPreferencesPermission as CoreMacOsPreferencesPermission;
use ctox_protocol::models::MacOsSeatbeltProfileExtensions as CoreMacOsSeatbeltProfileExtensions;
use ctox_protocol::models::MessagePhase;
use ctox_protocol::models::NetworkPermissions as CoreNetworkPermissions;
use ctox_protocol::models::PermissionProfile as CorePermissionProfile;
use ctox_protocol::models::ResponseItem;
use ctox_protocol::openai_models::InputModality;
use ctox_protocol::openai_models::ModelAvailabilityNux as CoreModelAvailabilityNux;
use ctox_protocol::openai_models::ReasoningEffort;
use ctox_protocol::openai_models::default_input_modalities;
use ctox_protocol::parse_command::ParsedCommand as CoreParsedCommand;
use ctox_protocol::plan_tool::PlanItemArg as CorePlanItemArg;
use ctox_protocol::plan_tool::StepStatus as CorePlanStepStatus;
use ctox_protocol::protocol::AgentStatus as CoreAgentStatus;
use ctox_protocol::protocol::AskForApproval as CoreAskForApproval;
use ctox_protocol::protocol::CodexErrorInfo as CoreCodexErrorInfo;
use ctox_protocol::protocol::CreditsSnapshot as CoreCreditsSnapshot;
use ctox_protocol::protocol::ExecCommandStatus as CoreExecCommandStatus;
use ctox_protocol::protocol::GranularApprovalConfig as CoreGranularApprovalConfig;
use ctox_protocol::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use ctox_protocol::protocol::HookEventName as CoreHookEventName;
use ctox_protocol::protocol::HookExecutionMode as CoreHookExecutionMode;
use ctox_protocol::protocol::HookHandlerType as CoreHookHandlerType;
use ctox_protocol::protocol::HookOutputEntry as CoreHookOutputEntry;
use ctox_protocol::protocol::HookOutputEntryKind as CoreHookOutputEntryKind;
use ctox_protocol::protocol::HookRunStatus as CoreHookRunStatus;
use ctox_protocol::protocol::HookRunSummary as CoreHookRunSummary;
use ctox_protocol::protocol::HookScope as CoreHookScope;
use ctox_protocol::protocol::ModelRerouteReason as CoreModelRerouteReason;
use ctox_protocol::protocol::NetworkAccess as CoreNetworkAccess;
use ctox_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
use ctox_protocol::protocol::RateLimitSnapshot as CoreRateLimitSnapshot;
use ctox_protocol::protocol::RateLimitWindow as CoreRateLimitWindow;
use ctox_protocol::protocol::ReadOnlyAccess as CoreReadOnlyAccess;
use ctox_protocol::protocol::RealtimeAudioFrame as CoreRealtimeAudioFrame;
use ctox_protocol::protocol::RealtimeConversationVersion;
use ctox_protocol::protocol::ReviewDecision as CoreReviewDecision;
use ctox_protocol::protocol::SessionSource as CoreSessionSource;
use ctox_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use ctox_protocol::protocol::SkillErrorInfo as CoreSkillErrorInfo;
use ctox_protocol::protocol::SkillInterface as CoreSkillInterface;
use ctox_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use ctox_protocol::protocol::SkillScope as CoreSkillScope;
use ctox_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
use ctox_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use ctox_protocol::protocol::TokenUsage as CoreTokenUsage;
use ctox_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
...
use ctox_protocol::user_input::ByteRange as CoreByteRange;
use ctox_protocol::user_input::TextElement as CoreTextElement;
use ctox_protocol::user_input::UserInput as CoreUserInput;
...
v2_enum_from_core!(
    pub enum ReviewDelivery from ctox_protocol::protocol::ReviewDelivery {
        Inline, Detached
    }
);

v2_enum_from_core!(
    pub enum McpAuthStatus from ctox_protocol::protocol::McpAuthStatus {
        Unsupported,
        NotLoggedIn,
        BearerToken,
        OAuth
...
impl SandboxPolicy {
    pub fn to_core(&self) -> ctox_protocol::protocol::SandboxPolicy {
        match self {
...
impl From<ctox_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: ctox_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            ctox_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            ...
            ctox_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
...
impl From<ctox_protocol::models::WebSearchAction> for WebSearchAction {
    fn from(value: ctox_protocol::models::WebSearchAction) -> Self {
        match value {
            ctox_protocol::models::WebSearchAction::Search { query, queries } => {
                WebSearchAction::Search { query, queries }
            }
            ctox_protocol::models::WebSearchAction::OpenPage { url } => {
                WebSearchAction::OpenPage { url }
            }
            ctox_protocol::models::WebSearchAction::FindInPage { url, pattern } => {
                WebSearchAction::FindInPage { url, pattern }
            }
            ctox_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
        }
    }
}
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> ctox_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => ctox_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => ctox_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => ctox_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
...
impl From<DynamicToolCallOutputContentItem>
    for ctox_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{
...
mod tests {
    use super::*;
    use ctox_protocol::items::AgentMessageContent;
    use ctox_protocol::items::AgentMessageItem;
    use ctox_protocol::items::ReasoningItem;
    use ctox_protocol::items::TurnItem;
    use ctox_protocol::items::UserMessageItem;
    use ctox_protocol::items::WebSearchItem;
    use ctox_protocol::models::WebSearchAction as CoreWebSearchAction;
    use ctox_protocol::protocol::NetworkAccess as CoreNetworkAccess;
    use ctox_protocol::protocol::ReadOnlyAccess as CoreReadOnlyAccess;
    use ctox_protocol::user_input::UserInput as CoreUserInput;
