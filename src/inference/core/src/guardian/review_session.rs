...
impl GuardianReviewSessionReuseKey {
    fn from_spawn_config(spawn_config: &Config) -> Self {
        Self {
            ...
            ctox_linux_sandbox_exe: spawn_config.ctox_linux_sandbox_exe.clone(),
...
pub(crate) fn build_guardian_review_session_config(
    ...
    live_network_config: Option<ctox_network_proxy::NetworkProxyConfig>,
    active_model: &str,
    reasoning_effort: Option<ctox_protocol::openai_models::ReasoningEffort>,
