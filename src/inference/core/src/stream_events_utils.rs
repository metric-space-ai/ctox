...
use ctox_utils_stream_parser::strip_proposed_plan_blocks;
use futures::Future;
use tracing::debug;
        ...
        && role == "assistant"
    {
        let combined = content
            ...
            .filter_map(|ci| match ci {
                ctox_protocol::models::ContentItem::OutputText { text } => Some(text.as_str()),
                _ => None,
            })
            .collect::<String>();
        ...
        | ResponseItem::ImageGenerationCall { .. } => {
            ...
            if let TurnItem::AgentMessage(agent_message) = &mut turn_item {
                ...
                agent_message.content =
                    vec![ctox_protocol::items::AgentMessageContent::Text { text: stripped }];
            }
