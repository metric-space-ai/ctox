...
use ctox_protocol::openai_models::ModelMessages;
use ctox_protocol::openai_models::ModelVisibility;
use ctox_protocol::openai_models::TruncationMode;
use ctox_protocol::openai_models::TruncationPolicyConfig;
...
pub(crate) fn with_config_overrides(mut model: ModelInfo, config: &Config) -> ModelInfo {
    ...
    if let Some(context_window) = config.model_context_window {
        ...
        // Harness overrides already represent the effective usable window for
        // the session. Do not re-apply model catalog safety percentages on top.
