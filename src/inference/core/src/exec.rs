...
use ctox_protocol::permissions::FileSystemSandboxKind;
...
use ctox_utils_pty::process_group::kill_child_process_group;
...
pub struct ExecParams {
    ...
    pub windows_sandbox_level: ctox_protocol::config_types::WindowsSandboxLevel,
...
fn select_process_exec_tool_sandbox_type(
    ...
    windows_sandbox_level: ctox_protocol::config_types::WindowsSandboxLevel,
...
pub fn build_exec_request(
    ...
    let exec_req = manager
        .transform(crate::sandboxing::SandboxTransformRequest {
            ...
            ctox_linux_sandbox_exe: ctox_linux_sandbox_exe.as_ref(),
            use_legacy_landlock,
            windows_sandbox_level,
            windows_sandbox_private_desktop,
        })
...
fn record_windows_sandbox_spawn_failure(
    ...
    let level = if matches!(
        windows_sandbox_level,
        ctox_protocol::config_types::WindowsSandboxLevel::Elevated
    ) {
        "elevated"
    } else {
        "legacy"
    };
    if let Some(metrics) = ctox_otel::metrics::global() {
...
async fn exec_windows_sandbox(
    ...
    use ctox_windows_sandbox::run_windows_sandbox_capture;
    use ctox_windows_sandbox::run_windows_sandbox_capture_elevated;
