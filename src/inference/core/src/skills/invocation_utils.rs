...
pub(crate) async fn maybe_emit_implicit_skill_invocation(
    ...
    let skill_scope = match invocation.skill_scope {
        ctox_protocol::protocol::SkillScope::User => "user",
        ctox_protocol::protocol::SkillScope::Repo => "repo",
        ctox_protocol::protocol::SkillScope::System => "system",
        ctox_protocol::protocol::SkillScope::Admin => "admin",
    };
