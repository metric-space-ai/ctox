...
#[test]
fn harness_override_sets_model_context_window() {
    ...
    assert_eq!(config.model_context_window, Some(131_072));
}
...
#[test]
fn tools_ctox_web_deserializes() {
    let cfg: ConfigToml = toml::from_str(
        r#"
[tools]
ctox_web = true
...
#[test]
fn tools_ctox_doc_deserializes() {
    let cfg: ConfigToml = toml::from_str(
        r#"
[tools]
ctox_doc = true
