...
async fn test_session_and_turn() -> (Arc<Session>, Arc<TurnContext>) {
    ...
    turn.file_system_sandbox_policy =
        ctox_protocol::permissions::FileSystemSandboxPolicy::from(turn.sandbox_policy.get());
    turn.network_sandbox_policy =
        ctox_protocol::permissions::NetworkSandboxPolicy::from(turn.sandbox_policy.get());
