...
keywords: ctox-state, migrations
---
### Task 1: migration-test
task: add-migration-test
task_group: ctox-state
...
- Confirmed no ordering regressions."
    ...
    assert!(raw_memories.contains("task_group: ctox-state"));
...
mod phase2 {
    ...
    use ctox_state::Phase2JobClaimOutcome;
    use ctox_state::Stage1Output;
    ...
    struct DispatchHarness {
        ...
        state_db: Arc<ctox_state::StateRuntime>,
    }
    ...
    impl DispatchHarness {
        async fn new() -> Self {
            ...
            let state_db = ctox_state::StateRuntime::init(
        ...
        async fn seed_stage1_output(&self, source_updated_at: i64) {
            ...
            let ownership_token = match claim {
                ctox_state::Stage1JobClaimOutcome::Claimed { ownership_token } => ownership_token,
