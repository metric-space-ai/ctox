...
use ctox_execpolicy::Evaluation;
use ctox_execpolicy::MatchOptions;
use ctox_execpolicy::Policy;
use ctox_execpolicy::RuleMatch;
...
use ctox_protocol::protocol::ExecApprovalRequestSkillMetadata;
use ctox_protocol::protocol::NetworkPolicyRuleAction;
use ctox_protocol::protocol::ReviewDecision;
use ctox_protocol::protocol::SandboxPolicy;
use ctox_shell_command::bash::parse_shell_lc_plain_commands;
use ctox_shell_command::bash::parse_shell_lc_single_command_prefix;
use ctox_shell_escalation::EscalateServer;
use ctox_shell_escalation::EscalationDecision;
use ctox_shell_escalation::EscalationExecution;
use ctox_shell_escalation::EscalationPermissions;
use ctox_shell_escalation::EscalationPolicy;
use ctox_shell_escalation::EscalationSession;
use ctox_shell_escalation::ExecParams;
use ctox_shell_escalation::ExecResult;
use ctox_shell_escalation::Permissions as EscalatedPermissions;
use ctox_shell_escalation::PreparedExec;
use ctox_shell_escalation::ShellCommandExecutor;
use ctox_shell_escalation::Stopwatch;
...
pub(super) async fn try_run_zsh_fork(
    ...
    let command_executor = CoreShellCommandExecutor {
        ...
        macos_seatbelt_profile_extensions: ctx
            ...
            .clone(),
        ctox_linux_sandbox_exe: ctx.turn.ctox_linux_sandbox_exe.clone(),
...
struct CoreShellCommandExecutor {
    ...
    network: Option<ctox_network_proxy::NetworkProxy>,
    ...
    macos_seatbelt_profile_extensions: Option<MacOsSeatbeltProfileExtensions>,
    ctox_linux_sandbox_exe: Option<PathBuf>,
    ...
    fn prepare_sandboxed_exec(
        ...
        let mut exec_request =
            sandbox_manager.transform(crate::sandboxing::SandboxTransformRequest {
                ...
                #[cfg(target_os = "macos")]
                macos_seatbelt_profile_extensions,
                ctox_linux_sandbox_exe: self.ctox_linux_sandbox_exe.as_ref(),
