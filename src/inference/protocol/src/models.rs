...
use ctox_utils_image::PromptImageMode;
use ctox_utils_image::load_for_prompt;
...
use ctox_git::GhostCommit;
use ctox_utils_absolute_path::AbsolutePathBuf;
use ctox_utils_image::error::ImageProcessingError;
...
// (Moved event mapping logic into ctox-core to avoid coupling protocol to UI-facing events.)
    ...
    fn includes_request_rule_instructions_for_on_request() {
        ...
        exec_policy
            .add_prefix_rule(
                ...
                ctox_execpolicy::Decision::Allow,
            )
            .expect("add rule");
        let instructions = DeveloperInstructions::from_permissions_with_network(
            SandboxMode::WorkspaceWrite,
