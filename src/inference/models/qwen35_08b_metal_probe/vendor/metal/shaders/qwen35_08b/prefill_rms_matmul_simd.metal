...
kernel void qwen35_08b_prefill_rms_matmul_rowtiles_tok4_simd_fp16_tiled_k1024_f32(
...
kernel void qwen35_08b_prefill_rms_matmul_rowtiles_tok8_simd_fp16_tiled_k1024_f32(
    device const half* x_tokens [[buffer(0)]],
    device const half* norm_weight [[buffer(1)]],
    device const half* w_tiled [[buffer(2)]],
    device float* y_tokens [[buffer(3)]],
